...
ax[0,0].bar(sv, pnf, width=10.0) #construction of bar graph at axes [0,0]
ax[0,0].set_ylabel("Percentage of Neurons Fired") #setting y axis label
ax[0,0].set_xlabel("Stimulus Voltage (mV)") #setting x axis label
ax[0,0].set_title("Effects of Stimulus Voltage on \n Nerve Fiber Recruitment \n within Skeletal Muscle") #setting title of graph
...
ax[0,1].fill(stretch, ca, "r") #construction of filled curve at axes [0,1]
ax[0,1].set_ylabel("Contraction Amplitude (N)") #setting y axis label
ax[0,1].set_xlabel("Stretch Imposed (mm)") #setting x axis label
ax[0,1].set_title("Effects of Stretch on Contractile Activity \n of Skeletal Muscle") #setting title of graph
